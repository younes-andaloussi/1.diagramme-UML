...
![Diagramme exercice 1](<image/exercice_01/Capture d'écran 2026-06-14 105226.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

> Espace reserve pour ajouter le diagramme UML, l'analyse, les acteurs, les cas d'utilisation ou la correction vue en classe.
...
![Diagramme exercice 2](<image/exercice_02/Capture d'écran 2026-06-14 122519.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

> Espace reserve pour ajouter le diagramme de classes, les classes principales, les associations, les multiplicites et les attributs.
...
![Diagramme exercice 3](<image/exercice_03/Capture d'écran 2026-06-14 125104.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

> Espace reserve pour ajouter les acteurs, les cas d'utilisation, les relations include/extend et le diagramme final.
...
![Diagramme exercice 4](<image/exercice_04/Capture d'écran 2026-06-14 132303.png>)
...
![Diagramme cas d'utilisation exercice 5](<image/exercice_05/Capture d'écran 2026-06-14 212325.png>)

#### Diagramme de sequence

![Diagramme de sequence exercice 5](<image/exercice_05/Capture d'écran 2026-06-14 214849.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

> Espace reserve pour ajouter les acteurs, les cas d'utilisation, les scenarios, le diagramme de sequence et le diagramme final.
...
![Diagramme cas d'utilisation exercice 6](<image/exercice_06/utilisation 2026-06-15 200144.png>)

#### Diagramme de classes

![Diagramme de classes exercice 6](<image/exercice_06/classe 2026-06-15 211931.png>)

#### Diagramme de sequence

![Diagramme de sequence exercice 6](<image/exercice_06/sequence 2026-06-16 142727.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

#### Cas d'utilisation

> Espace reserve pour identifier les acteurs, les cas d'utilisation et les relations include/extend.

#### Diagramme de classes

> Espace reserve pour ajouter les classes, attributs, associations, generalisations et multiplicites.

#### Diagramme de sequence

> Espace reserve pour le scenario principal "Gestion d'une expedition nationale ou legere".

#### Scenarios principaux

> Espace reserve pour documenter les scenarios principaux des autres cas d'utilisation.
...
![Diagramme cas d'utilisation exercice 7](<image/exercice_07/cas utilisation 2026-06-16 174202.png>)

#### Diagramme de classes

![Diagramme de classes exercice 7](<image/exercice_07/classe 2026-06-16 182449.png>)

#### Diagramme de sequence

![Diagramme de sequence exercice 7](<image/exercice_07/sequence 2026-06-16 183636.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

#### Diagramme de classes

> Espace reserve pour ajouter les classes, attributs, operations, relations et multiplicites.

#### Diagramme de cas d'utilisation

> Espace reserve pour ajouter les acteurs et les cas d'utilisation du systeme de gestion de l'hotel.

#### Diagramme de sequence

> Espace reserve pour le scenario de reservation d'une chambre par un adulte.
...
![Diagramme cas d'utilisation exercice 8](<image/exercice_08/cas utilisation 2026-06-16 190224.png>)

#### Diagramme de classes

![Diagramme de classes exercice 8](<image/exercice_08/classe 2026-06-16 193942.png>)

#### Diagramme de sequence

![Diagramme de sequence exercice 8](<image/exercice_08/sequence 2026-06-16 201356.png>)
...
> Espace reserve pour les acteurs, les cas d'utilisation et les relations include/extend.

#### Diagramme de classes

> Espace reserve pour les classes, attributs, associations et multiplicites.

#### Diagramme de sequence

> Espace reserve pour le scenario "Emprunter un livre" avec le bloc conditionnel alt.
...
![Diagramme cas d'utilisation exercice 9](<image/exercice_09/utilisation 2026-06-17 082022.png>)

#### Diagramme de classes

![Diagramme de classes exercice 9](<image/exercice_09/classe 2026-06-17 084950.png>)

#### Diagramme de sequence

![Diagramme de sequence exercice 9](<image/exercice_09/sequence 2026-06-17 091838.png>)
...
> Espace reserve pour l'acteur, le systeme, les cas d'utilisation et les relations include.
...
> Espace reserve pour le scenario "Reserver un trajet" avec loop et alt.
...
![Diagramme cas d'utilisation exercice 10](<image/exercice_10/cas utilisation 2026-06-17 171220.png>)

#### Diagramme de classes

![Diagramme de classes exercice 10](<image/exercice_10/classe 2026-06-17 203607.png>)

#### Diagramme de sequence

![Diagramme de sequence exercice 10](<image/exercice_10/sequence 2026-06-17 205417.png>)
...
> Espace reserve pour les acteurs, les cas d'utilisation et les relations include.

#### Diagramme de classes

> Espace reserve pour les classes, attributs, associations, heritages et multiplicites.

#### Diagramme de sequence

> Espace reserve pour le scenario de dechargement ou de chargement avec une boucle loop.
...
![Diagramme de sequence exercice 11](<image/exercice_11/sequence 2026-06-17 212957.png>)

### <span style="color:#0f766e;">Correction / Notes</span>

#### Diagramme de sequence

> Espace reserve pour le diagramme de sequence du retrait d'argent dans le cas nominal.
...
> Espace reserve pour le diagramme de sequence du processus de commande et de fabrication d'une composition florale.
...
> Espace reserve pour le diagramme de sequence du passage en caisse avec paiement en liquide.
...
> Espace reserve pour les acteurs, les cas d'utilisation principaux et les relations du systeme de gestion immobiliere.
